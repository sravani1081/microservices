 ...
 * File: metricsCollector_component.jsx
...
export default function MetricsCollectorModuleView() {
  const [activeUnit, setActiveUnit] = useState(1);
  return (
    <div className="glass-panel p-6 rounded-2xl space-y-4">
      <div className="flex items-center space-x-3">
        <Server className="w-6 h-6 text-cyan-400" />
        <h3 className="text-lg font-bold text-white">METRICSCOLLECTOR Enterprise Panel</h3>
      </div>
